...
def create_output_images(Rover):
      ...
      cv2.putText(map_add,"Time: "+str(np.round(Rover.total_time, 1))+' s', (0, 20), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.6, (255, 255, 255), 1)
      cv2.putText(map_add,"Mapped: "+str(perc_mapped)+'%', (0, 40), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.6, (255, 255, 255), 1)
      cv2.putText(map_add,"Fidelity: "+str(fidelity)+'%', (0, 60), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.6, (255, 255, 255), 1)
      cv2.putText(map_add,"Rocks", (0, 80), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.6, (255, 255, 255), 1)
      cv2.putText(map_add,"  Located: "+str(samples_located), (0, 100), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.6, (255, 255, 255), 1)
      cv2.putText(map_add,"  Collected: "+str(Rover.samples_collected), (0, 120), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.6, (255, 255, 255), 1)
      ...
      Rover.mapping_percentage = perc_mapped
